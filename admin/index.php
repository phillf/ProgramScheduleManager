...
<script type="text/javascript" src="../includes/js/jquery.fancybox.js?v=2.0.6"></script>
<script src="../includes/js/fancyFunction.js"></script>
<script src="../includes/js/picnet.table.filter.min.js"></script>
...
<link href="../includes/js/jquery.fancybox.css" rel="stylesheet" type="text/css" />
...
<div id="container">
<div id="quickFind">Quick Find: <input type='text' id='quickfind'/></div>
	<div id="stripe">
	<table width="100%" cellpadding="0" cellspacing="0" id="stripe">
		<thead>
			<tr>
				<th width="10%">Air Time</th>
				<th width="10%">End Time</th>
				<th class="type-string" width="20%">Show Name</th>
				<th width="50%">Show Description</th>
				<th width="10%">Toolbox</th>
			</tr>
		</thead>
		<tbody>
		<?php
		...
		{?>
	  		<tr>
				...
				<td><? echo $Show["ShowName"] ?></td>
     			<td><?php echo $Show["ShowDesc"]; ?></td>
     			<td><a href="./editShow.php?ID=<?php echo $Show["ID"] ?>" target="_blank">Edit Show</a><form action="../includes/removeShow.php" method="POST"><input type="hidden" name="ID" value="<?php echo $Show['ID'];?>"><input type="submit" value="Delete" /></form></td>
     		</tr>
    	<? } ?>
        </tbody>
	</table>
